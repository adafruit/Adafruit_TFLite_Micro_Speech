...
extern "C" { void SysTick_Handler(void) {  PDM.IrqHandler(); } } // extern C
...
TfLiteStatus InitAudioRecording(tflite::ErrorReporter* error_reporter) {
  Serial.println("Initializing PDM audio");
  ...
  SysTick_Config(F_CPU/16000); // run systick @ 16khz
...
#ifdef DEBUG_SAMPLES
    Serial.printf("%d, ", g_audio_capture_buffer[capture_index]);
#endif
  }
